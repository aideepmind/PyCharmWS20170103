...
# LabelEncoder
train = pd.read_csv('kaggle/kaggle-lmgpip-master/input/train.csv', index_col=None)
test = pd.read_csv('kaggle/kaggle-lmgpip-master/input/test.csv', index_col=None)
...
train.to_csv('kaggle/kaggle-lmgpip-master/temp/train2.csv', index=None)
test.to_csv('kaggle/kaggle-lmgpip-master/temp/test2.csv', index=None)


# DictVectorizer----------------好像重复了
train = pd.read_csv('kaggle/kaggle-lmgpip-master/temp/train2.csv', index_col=None)
test = pd.read_csv('kaggle/kaggle-lmgpip-master/temp/test2.csv', index_col=None)
...
train.to_csv('kaggle/kaggle-lmgpip-master/temp/train3.csv', index=None)
test.to_csv('kaggle/kaggle-lmgpip-master/temp/test3.csv', index=None)
...
train.to_csv('kaggle/kaggle-lmgpip-master/temp/train4.csv', index=None)
test.to_csv('kaggle/kaggle-lmgpip-master/temp/test4.csv', index=None)
